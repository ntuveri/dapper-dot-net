...
#pragma warning restore 0618
        ...
        internal static Action<IDbCommand, object> CreateParamInfoGenerator(Identity identity, bool checkForDuplicates, bool removeUnused, IList<LiteralToken> literals)
        {
            ...
            foreach (var prop in props)
            {
                ...
                ITypeHandler handler;
                DbType? dbType = LookupDbType(prop.PropertyType, prop.Name, false, out handler);
    ...
    partial class DynamicParameters : SqlMapper.IDynamicParameters, SqlMapper.IParameterLookup, SqlMapper.IParameterCallbacks
    {
        ...
        partial class ParamInfo
        {
            ...
            internal static void ToIDataParameter(IDataParameter param, ParamInfo pi)
            {
                ...
                { 
                    dbType = SqlMapper.LookupDbType(pi.Value.GetType(), Clean(pi.Name), true, out handler);
                }
                IDbDataParameter dbParam = param as IDbDataParameter;
...
#pragma warning restore 612, 618
    ...
    partial class FeatureSupport
    {
        private static readonly FeatureSupport
            @default = new FeatureSupport(false, false),
            postgres = new FeatureSupport(true, false),
            sqlserver = new FeatureSupport(false, true);
        ...
        public static FeatureSupport Get(IDbConnection connection)
        {
            ...
            if (string.Equals(name, "sqlconnection", StringComparison.InvariantCultureIgnoreCase)) return sqlserver;
            return @default;
        }
        private FeatureSupport(bool arrays, bool deriveParameters)
        {
            Arrays = arrays;
            DerivedParameters = deriveParameters;
        }
        /// <summary>
        ...
        /// </summary>
        public bool DerivedParameters { get; private set; }
    }
